            ...
            <div className='bg-slate-300 h-auto'>
                <div className='justify-center items-center text-center w-2/3 mx-auto '>
                    ...
                    <div className='flex gap-2 text-center justify-center p-4'>
                        <NavLink to={'https://play.google.com/store/apps'}><button className='flex border-1 bg-violet-200 items-center text-center p-1 rounded-xl' ><BiLogoPlayStore className='text-2xl'></BiLogoPlayStore>PlayStore</button></NavLink>
                    <NavLink to={'https://www.apple.com/sa/app-store/'}><button className='flex border-1 bg-violet-200 items-center text-center p-1 rounded-xl' ><FaAppStore className='text-2xl text-blue-400'></FaAppStore>AppStore</button></NavLink>
                    </div>
